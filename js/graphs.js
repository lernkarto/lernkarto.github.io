...
const GRAPH_RECIPES = {
  ...
  "normal-hypothesis": {
    ...
    render(svg, p) {
      ...
      svg.appendChild(svgText(GRAPH_W - GRAPH_PAD.r, GRAPH_PAD.t - 5,
        `α=${alpha.toFixed(1)}%  β=${beta.toFixed(1)}%  power=${power.toFixed(1)}%`,
        { "text-anchor": "end", fill: "#aaa", "font-size": "8.5" }));
    },
  },
};
